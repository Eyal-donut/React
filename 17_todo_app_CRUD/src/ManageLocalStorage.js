const setItemToLocalStorage = (todoIdentifier, todoItem) => {
  ...
  const toggleIsDone = (todoIdentifier) => {
    ...
    todoItem.isDone === false ? todoItem.isDone = true : todoItem.isDone = false;
    setItemToLocalStorage(todoItem.id, todoItem)
  }

  export { setItemToLocalStorage, getItemFromLocalStorage, removeFromLocalStorage, toggleIsDone }